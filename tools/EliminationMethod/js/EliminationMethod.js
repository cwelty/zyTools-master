...
/**
    Progression that generates and displays systems of equations to solve via elimination method problems.
    ...
    this.init = function(id, parentResource) {
        require('singleInputQuestionProgressionTool').create().init(
            ...
            parentResource,
            {
                ...
                displayTemplate: this['<%= grunt.option("tool") %>'].EliminationMethod,
...
const EliminationMethodExport = {
    create: function() {
        buildPrototypes();
        return new EliminationMethod();
    },
...
module.exports = EliminationMethodExport;

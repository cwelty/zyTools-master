...
/**
    Progression that generates general questions about the greatest common factor of polynomials.
    @module PolynomialsGCF
    @return {void}
*/
function PolynomialsGCF() {
    ...
    this.init = function(id, parentResource) {
        require('singleInputQuestionProgressionTool').create().init(
            ...
            parentResource,
            {
                ...
                displayTemplate: this['<%= grunt.option("tool") %>'].PolynomialsGCF,
...
const PolynomialsGCFExport = {
    create: function() {
        buildPrototypes();
        return new PolynomialsGCF();
    },
...
module.exports = PolynomialsGCFExport;

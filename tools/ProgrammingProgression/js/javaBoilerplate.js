/* exported javaBoilerplate */
/* eslint-disable */
'use strict';

const javaBoilerplate = `import java.io.OutputStream;
...
public class main {
    ...
    public static {{{testFunctionReturns}}} testStudentCode({{#if programInput}}String zyInput{{#if testFunctionParameters}}, {{/if}}{{/if}}{{testFunctionParameters}}) {
{{#if programInput}}
...
{{/if}}
    ...
    public static {{{testFunctionReturns}}} testSolutionCode({{#if programInput}}String zyInput{{#if testFunctionParameters}}, {{/if}}{{/if}}{{testFunctionParameters}}) {
{{#if programInput}}
        InputStream inStream = new ByteArrayInputStream(zyInput.getBytes(Charset.forName("UTF-8")));
        System.setIn(inStream);
{{/if}}
